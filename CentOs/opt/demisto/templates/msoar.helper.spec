...
# user HOME
  cp /home/user/.ssh/authorized_keys user_authorized_keys
# demisto Home
  cp /home/demisto/.bash_profile demisto.bash_profile
  cp /home/demisto/.ssh/authorized_keys demisto_authorized_keys
# Conf-files
...
# Hint - we need to use the force parameter else we got an error because the user already exists in the domain.
...
# Install the Files
  ...
  install demisto $RPM_BUILD_ROOT/etc/sudoers.d/demisto
# Sysconfig
  ...
  install shells $RPM_BUILD_ROOT/etc/shells.demisto
# Sysctl
  install 999-demisto.conf $RPM_BUILD_ROOT/etc/sysctl.d/999-demisto.conf
# user HOME
  install user_authorized_keys $RPM_BUILD_ROOT/home/user/.ssh/authorized_keys
# demisto Home
  install demisto.bash_profile $RPM_BUILD_ROOT/home/demisto/.bash_profile
  install demisto_authorized_keys $RPM_BUILD_ROOT/home/demisto/.ssh/authorized_keys
# Conf-files
...
# Sysconfig
  ...
  %config(missingok) %attr(644, root, root) /etc/shells.demisto
# Sysctl
...
# demisto Home
                ...
                %dir %attr(700, demisto, demisto) /home/demisto/.ssh
                     %attr(600, demisto, demisto) /home/demisto/.ssh/authorized_keys
# Conf-files
...
systemctl enable demisto.backup.timer
systemctl start demisto.backup.timer
...
%changelog
* Thu Apr 30 2020 Alexander Huser 1.0.0
	- Initial Release
